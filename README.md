...
If I were extending this beyond the interview scope, I would focus on these areas.

### 1. Better catalogue curation

- strengthen philosophy-vs-adjacent filtering,
- separate "core philosophy" from "philosophical fiction" or "adjacent thought,"
- improve handling of sparse records.

### 2. Phase 3 interaction logging

- assign stable anonymous users,
- log recommendation impressions and clicks,
- store interaction history in SQLite,
- begin collaborative reranking.

### 3. Evaluation

Right now the repo is stronger on architecture than on formal evaluation.

A next serious step would be to add:

- curated prompt test sets,
- judged recommendation relevance,
- retrieval quality comparisons between variants,
- and basic offline metrics.

### 4. Better explanation quality

Current explanations are serviceable, but they are still fairly thin. A stronger version would generate explanations that are:

- grounded in retrieved metadata,
- specific about the match,
- and robust enough to justify surprising recommendations.
